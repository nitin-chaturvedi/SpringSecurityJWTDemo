...
public class MyUserDetailsService implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
    ...
    // In real use case fetch entity from DB and create a MyUserDetails class which implements
    // UserDetails return the object of MyUserDetails class and use the overridden methods to
