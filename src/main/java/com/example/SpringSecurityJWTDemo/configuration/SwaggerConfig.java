...
public class SwaggerConfig implements WebMvcConfigurer {
  ...
  private ApiInfo getApiInfo() {
    return new ApiInfo(
      ...
      "Demo project for Spring Boot security with JWT and Swagger."
        + " Swagger to be disabled in production config.",
      "1.0",
      "Free to use",
        new Contact("Nitin Chaturvedi", "https://www.linkedin.com/in/nitin-chaturvedi-b2348333",
        "test@test.com"),
      "API Liscense",
